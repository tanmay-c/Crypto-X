...
const Homepage = () => {
    ...
    return (
        ...
        <Row>
            <Col span={12}><Statistic title="Total Cryptocurriencies" value={globalStats.total}></Statistic></Col>
            ...
            {/* <Col span={12}><Statistics title="Total Cryptocurriencies" value="5"></Statistics></Col> */}
